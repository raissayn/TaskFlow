...
Observação importante: a porta 5000 pode já estar em uso no ambiente, então uma alternativa funcional foi subir a API em 5001. O projeto tem seu Swagger em:
